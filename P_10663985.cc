...
int e;
int del;
int z=0,x=0, i=0,j=0,r=0,c=0,cNo[10];
int print,addStaff=0,v0=0,v=0, eSLoop=0;
          ...
          { system("cls");
           ...
           { system("cls");
             ...
             {  while (eSLoop<=10)
                   ...
                   { system("cls");
                    cout<<"Due to re-calculation of CGPA, enter all the student's courses at fresh again\n";
